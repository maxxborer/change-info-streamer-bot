...
Кнопка YouTube Studio открывает страницу известного monitored broadcast, в том числе запланированного. Если Streamer.bot не отслеживает broadcast, открывается раздел прямых трансляций подключённого YouTube-канала.
